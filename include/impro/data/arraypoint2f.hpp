#ifndef IMPRO_DATA_ARRAYPOINT2F_HPP
#define IMPRO_DATA_ARRAYPOINT2F_HPP
...
// ??
#define IMPRO_DATA_ARRAYPOINT2F "ArrayPoint2f"
...
namespace impro
{
    ...
    {
        /**
         * @brief The Impro ArrayPoint2f Data class
         */
        class IMPRO_EXPORTS ArrayPoint2f : public Data
        {
        public:
            /**
             * @brief newPtr
        ...
        public:
            std::vector<cv::Point2f> vec_;

        };
    }
}

#endif // IMPRO_DATA_ARRAYPOINT2F_HPP
