#ifndef IMPRO_DATA_ARRAYVEC3F_HPP
#define IMPRO_DATA_ARRAYVEC3F_HPP
...
// ??
#define IMPRO_DATA_ARRAYVEC3F "ArrayVec3f"
...
namespace impro
{
    ...
    {
        /**
         * @brief The ArrayVec3f class
         */
        class IMPRO_EXPORTS ArrayVec3f : public Data
        {
        public:
            /**
             * @brief newPtr
        ...
        public:
            std::vector<cv::Vec3f> vec_;
        };
    }
}

#endif // IMPRO_DATA_ARRAYVEC3F_HPP
