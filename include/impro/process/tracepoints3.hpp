#ifndef IMPRO_PROCESS_TRACEPOINTS3_HPP
#define IMPRO_PROCESS_TRACEPOINTS3_HPP
...
namespace impro
{
    namespace process
    {
        class IMPRO_EXPORTS TracePoints3 : public Process,
                                          public ChannelObserver
        {
        public:
            TracePoints3(const std::string &id,
        ...
        class IMPRO_EXPORTS TracePoints3Creator : public ProcessCreator
        {
        public:
            TracePoints3Creator(const std::string &spaceId,
                               const std::string &outputChannelId,
                               const std::string &inputNodeId,
                               const std::string &inputChannelId,
                               int searchSize)
