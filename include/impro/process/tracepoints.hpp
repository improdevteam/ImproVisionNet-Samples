#ifndef IMPRO_PROCESS_TRACEPOINTS_HPP
#define IMPRO_PROCESS_TRACEPOINTS_HPP
...
namespace impro
{
    ...
    namespace process
    {
        class IMPRO_EXPORTS TracePoints : public Process,
                                          public ChannelObserver
        {
        public:
            TracePoints(const std::string &id,
        ...
        class IMPRO_EXPORTS TracePointsCreator : public ProcessCreator
        {
        public:
            TracePointsCreator(const std::string &spaceId,
                               const std::string &outputChannelId,
                               const std::string &inputNodeId,
                               const std::string &inputChannelId,
                               int searchSize)
...
#endif // IMPRO_PROCESS_TRACEPOINTSPROCESS_HPP
